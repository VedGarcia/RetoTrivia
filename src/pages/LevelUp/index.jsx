  ...
  return (
    <Layout>
      <div className="w-3/4 h-3/4 grid gap-6 place-content-center rounded-2xl  bg-purple-200 border-4 border-purple-600 ">
        ...
        <Link to={"/question"} className="hover:bg-purple-800 w-2/4 h-16 border-4 m-auto text-center border-purple-900 hover:shadow-xl hover:shadow-violet-500 rounded-full grid place-content-center p-4 text-3xl font-medium text-purple-900 hover:text-white">
          Siquiente pregunta
        </Link>
      </div>
    </Layout>
